...
def get_subwindow(im, pos, target_sz, model_sz, original_sz, avg_chans, out_mode='torch', new=False):
    ...
    h = target_sz[1]
#    print("pos = " + str(pos))
#    print("target_sz = " + str(target_sz))
#    print("image shape = " + str(im.shape))
    context_xmin = abs(xmin)
    context_xmax = xmin + w
    context_ymin = abs(ymin)
    context_ymax = ymin + h

#    print("xmin = %f , xmax = %f" % (context_xmin,context_xmax))
    im_patch_original = im[int(context_ymin):int(context_ymax + 1), int(context_xmin):int(context_xmax + 1), :]
#    print("im_patch_original  shape = " + str(im_patch_original.shape))

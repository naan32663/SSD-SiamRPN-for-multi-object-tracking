# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 21:32:01 2020
...
from models.loss import rpn_cross_entropy, rpn_smoothL1
from image import load_data, generate_anchor, load_data_rpn
from models.builder import SiamRPN
import dataset

from utils import save_checkpoint
from models.lr_scheduler import LogScheduler, StepScheduler, MultiStepScheduler, LinearStepScheduler, CosStepScheduler,WarmUPScheduler
...
def main():
    ...
    assert os.path.isfile('youtube_final.txt')
...
def trainRPN(model, optimizer, epoch, coco):
    ...
    train_loader = torch.utils.data.DataLoader(
        dataset.listDataset(args.youtube, args.data_type,
                            shuffle=True,
